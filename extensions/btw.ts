 ...
 *
 * A pi extension that lets you have a separate, parallel conversation with the LLM
 * while the main agent is working. Think of it as whispering to an assistant
 * without interrupting the one doing the actual work.
 *
 * Commands:
 * /btw <message>         - Send a message in the side conversation
 * /btw:new [message]     - Start a fresh side thread
 * /btw:clear             - Dismiss the widget and clear thread
 * /btw:inject [instructions] - Inject full btw thread into main agent context
 * /btw:summarize [instructions] - Summarize and inject into main agent context
 */
